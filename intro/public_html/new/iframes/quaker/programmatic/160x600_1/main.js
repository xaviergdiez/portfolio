function initBanner() {
    ...
    tl
        ...
        .set([ctatext,ctabox],{scale:0.9, transformOrigin:"80px 440px"})
        
        .set([frame2top,frame3top],{x:450,autoAlpha:1})
        .set([frame2bottom,frame3bottom],{x:-450,autoAlpha:1})
