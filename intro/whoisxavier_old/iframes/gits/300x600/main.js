//$(window).load(function(){
    ...
    tl2 
        ...
        .set([logo_draw, logo_fill, logo_shadow], {y:-150})
        .set(packshot_container, {y:125, scale:0, transformOrigin:"158px 334.5px"})
        .set(cta_container, {y:50, scale:0.8, transformOrigin:"center center"})
